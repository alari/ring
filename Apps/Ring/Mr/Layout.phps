		...
		if (!R_Mdl_Session::isLogged())
			$this->addJavaScriptSrc( 
					"http://" . O_Registry::get( "app/hosts/center" ) . "/JsLogin?ref=http://" .
						 O_Registry::get( "app/hosts/project" ) . $_SERVER[ 'REQUEST_URI' ] );
...
<div id="foot">
<div class="cont"><span>Кольцо творческих сайтов Mirari.Name | <a
	href="http://<?=O_Registry::get( "app/hosts/center" )?>/">Оглядеться из
центра</a></span></div>
...
<p><a href="http://<?=O_Registry::get( "app/hosts/center" )?>/">Оглядеться
из центра</a></p>
<?
