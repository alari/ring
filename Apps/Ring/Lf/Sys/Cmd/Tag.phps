...
class R_Lf_Sys_Cmd_Tag extends R_Lf_Sys_Command {
	...
	public function process()
	{
		...
		$tpl->paginator = $query->getPaginator( array ($this, "url"), $this->instance->perpage );
	...
	{
		return $this->tag && $this->instance && $this->can( 
				"read " . $this->instance->system[ "access" ], $this->getSite() );
	}
