<?php
/**
 * @table anonces -loop-full:callback R_Fr_Site_Anonce::showFullQuery -show-rss:callback R_Fr_Site_Anonce::showRssItem \
 * 			-loop:callback R_Fr_Site_Anonce::showQuery -show:callback R_Fr_Site_Anonce::showSelf
 *
