 ...
 * @field display_on_homepage ENUM('anonces','full') DEFAULT 'anonces' -enum anonces:Анонсы; full:Как в ленте -title Как отображать на главной странице -edit enum
 * @field show_avatar ENUM('yes','no') DEFAULT 'yes' -enum yes:Да; no:Нет -title Показывать аватарку на страницах произведений? -edit enum
 */
