...
class R_Fr_Sys_Afisha_Bill extends R_Fr_Sys_Creative {
...
<?
		if ($post->anonce->description) {
			?><h5><?=$post->anonce->description?></h5><?
		}
		?>
...
<div class="cvr"><strong><?=$record->link()?> / <?=date( "d.m.Y", $record->time )?></strong>
<div class="cnt">
<?
